...
import './companies-even-row.css'

const CompaniesEvenRow = (props) => {
  return (
    <div className={`companies-even-row-companies-row ${props.rootClassName} `}>
...
export default CompaniesEvenRow
